...
@section('content')
    {{-- Welcome --}}
    <div class="fu d1">
        <h1 class="txt-primary" style="font-size:22px;font-weight:800;">Selamat Pagi, {{ auth()->user()->name ?? 'Admin' }} 👋</h1>
        <p class="txt-muted" style="font-size:13px;margin-top:3px;">{{ now()->translatedFormat('l, d F Y') }} &mdash; Semester
            Ganjil 2025/2026</p>
    </div>
        ...
        <div class="glass-card" style="padding:24px;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;">
                <div>
                    ...
                    <p class="txt-muted" style="font-size:12px;margin-top:2px;">Total 450 siswa terdaftar</p>
                </div>
                <div
