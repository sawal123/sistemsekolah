...
@php
    $baseClass = "inline-flex items-center justify-center gap-2 px-4 py-2 font-semibold text-sm rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
    ...
    $variants = [
        ...
        'secondary' => 'glass text-gray-700 dark:text-gray-200 hover:bg-white/40 dark:hover:bg-white/10 focus:ring-gray-300',
