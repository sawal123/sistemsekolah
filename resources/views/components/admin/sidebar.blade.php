<aside id="sidebar" class="glass-sidebar h-full flex flex-col z-50 absolute lg:relative overflow-y-auto"
    ...
    {{-- Logo --}}
    <div class="px-5 py-5 flex items-center justify-between border-b" style="border-color:rgba(99,102,241,0.12);">
        ...
        <button @click="$store.sidebar.toggle()"
            class="lg:hidden flex items-center justify-center hover:bg-red-500/20 transition-all z-50 cursor-pointer"
            style="width:32px;height:32px;border-radius:8px;border:none;background:rgba(239,68,68,0.1);color:#ef4444;">
    ...
    {{-- Menu --}}
    <nav id="sidebar-menu" class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto" style="min-width:242px;">
    ...
    <div class="px-4 py-4" style="border-top:1px solid rgba(99,102,241,0.10);">
        <div style="display:flex;align-items:center;gap:10px;white-space:nowrap;">
            ...
            <div style="flex:1;min-width:0;">
                ...
                <p class="txt-muted" style="font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                    {{ auth()->user()->email ?? '' }}
                </p>
            </div>
